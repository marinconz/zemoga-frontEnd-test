...
const HeroCard = () => (
  <div className={`${styles.heroCard} ${styles.container}`}>
    <div className={styles.heroFeaturedCard}>
      <div className={styles.featuredCardGlassBackground} />
      <div className={styles.featuredCardContent}>
        <p className={styles.featuredCardHairline}>{'What\'s your opinion on'}</p>
        <h2 className={styles.featuredCardTitle}>Pope Francis?</h2>
